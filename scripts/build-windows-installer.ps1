...
.DESCRIPTION
  ...
  compiles an Inno Setup installer. DeepSeek Harness is NOT bundled: the DSH
  bridge ships as the @beauticode/dsh-plugin package that users install into
  their own DSH profile.
#>
[CmdletBinding()]
param(
